...
public class ADAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ADADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ADAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ADADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ADADateTimeConverter dateTimeConverter = new ADAStandardDateTimeConverter();

    public ADAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ADAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ADAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ADAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ADAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ADAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
