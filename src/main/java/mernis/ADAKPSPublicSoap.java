...
public class ADAKPSPublicSoap
{
    ...
    public ADAKPSPublicSoap(){}

    public ADAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ADAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ADAExtendedSoapSerializationEnvelope envelope= new ADAExtendedSoapSerializationEnvelope(ADAExtendedSoapSerializationEnvelope.VER11);
